      ...
      <div class="list-group">
        <a
          ...
          class={classnames('list-group-item', {
            active: _.contains(this.state.percentages, 20),
          })}
        >
          <h6>Certified organic</h6>
          <p class="text-sm text-black">
            By choosing this option we use certified organic/pesticide free
            fruits and nuts in your smoothies.
          </p>
        </a>
        <a
          href="#"
          ...
          class={classnames('list-group-item', {
            active: _.contains(this.state.percentages, 5),
          })}
        >
          <h6>Vegan friendly</h6>
          <p class="text-sm text-black">
            By choosing this option we use plant-based yogurt with live culture
            in your smoothies.
          </p>
        </a>
        <a
          ...
          class={classnames('list-group-item', {
            active: _.contains(this.state.percentages, 10),
          })}
        >
          <h6>Activated nuts</h6>
          <p class="text-sm text-black">
            By choosing this options all the seeds and nuts in your smoothies
            are activated and easy to digest.
          </p>
        </a>
      </div>
    );
