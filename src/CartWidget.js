...
class CardWidget extends Component {
  ...
  renderCartItem() {
    if (this.props.cart.length > 0) {
      return this.props.cart.map((p, index) => {
        return (
          <div key={index} class="cart-items-item clearfix">
            ...
            <div class="float-left">
              ...
              <a
                href="#"
                class="close cart-remove text-primary"
    ...
    return (
      <div>
        ...
        <a
          id="Popover1"
          onClick={this.toggle}
          className="btn btn-icon btn-dark btn-link float-right dropdown-toggle cart-link"
        >
          <span className="cart-link-icon">
            <i className="fa fa-shopping-cart" />
            <span className="sr-only">Cart</span>
            <span className="cart-link-count bg-primary text-white">
        ...
        >
          ...
          <PopoverBody>
            <div className="cart-dropdown-menu">
              <div class="cart-items">{this.renderCartItem()}</div>
              <hr class="mt-3 mb-0" />
                ...
                <h5 class="font-weight-bold">
                  ...
                  <span class="text-primary">
                    ${_.reduce(
                      this.props.cart,
                      (memo, p) => {
                        return memo + p.price * p.quantity;
                      },
                      0
                    )}
                  </span>
