...
class App extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    this.setState({
      ...
      bundles: _.filter(nextProps.products.entities, p => {
        return p.category.name === 'Bundles';
      }),
      featured: _.filter(nextProps.products.entities, p => {
        return p.category.name !== 'Bundles';
      }),
      ...
      <div className="App">
          ...
          <div className="header-inner container">
            <div className="header-block-flex order-1 mr-auto">
              <nav className="text-xs rounded p-1 mb-1 mb-lg-0 ">
                <span className="fa fa-asterisk" /> Free delivery on orders over
                $100
              </nav>
            </div>
            <div className="nav nav-icons header-block order-12">
              ...
              >
                {' '}
                <i className="fa fa-facebook-square icon-1x" />{' '}
              ...
              >
                {' '}
                <i className="fa fa-instagram icon-1x" />{' '}
        ...
        <StickyContainer>
          ...
          <div className="">
            ...
            <Route
              exact
              path="/confirmation/:reference_number"
            ...
            <Route
              exact
              path="/shop/categories/:category_id"
              component={props => (
                <Shop
                  {...props}
                  products={this.state.products}
