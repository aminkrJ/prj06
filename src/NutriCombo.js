...
<iframe width="560" height="315" src="https://www.youtube.com/embed/KGzT8CMoBQc" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
        ...
        <div class="row align-items-center padding-top-2x padding-bottom-2x">
          ...
          <div class="col-md-7 text-md-left text-center">
            ...
            <p>
NutriCombo is low in carbs and high in healthy fats. When you overload your body with fats and take away carbohydrates, it will begin to burn ketones, the breakdown of fats in the liver, as the primary energy source. Optimal ketone levels offer many health, weight loss, physical and mental performance benefits.
      </p>
          </div>
        </div>
        <hr />
