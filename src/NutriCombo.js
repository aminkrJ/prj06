      ...
      <Modal title="Newsletter">
        <p class="text-sm">
          <span class="font-weight-bold text-uppercase">
            Sign up to receive more hacks.
          </span>{' '}
          Plus be the first to know about our exclusive offers and deals,
          special events, and product releases!
        </p>
        <Subscribe />
      </Modal>,
                ...
                <div class="container padding-bottom-2x mb-2">
                  <div class="row align-items-center padding-bottom-2x">
                    <div class="col">
                      ...
                      <p>{globals.nutricombo.description}</p>
                    </div>
                    <div class="col">
                      <div class="embed-responsive embed-responsive-16by9">
                        <iframe
                          width="560"
                          height="315"
                          src="https://www.youtube.com/embed/sQwljK9S9A0"
                          frameborder="0"
                  ...
                  <div id="features" className="container">
                    ...
                    <h5 className="text-center font-weight-light mt-2 mb-0 text-muted">
                      Eliminate the followings while you are on NutriCombo to
                    ...
                    <div className="row ">
                      <div className="col-lg-6 py-2">
                        <h5 className="text-uppercase mt-2">
                          <span class="text-danger fa fa-close mb-2 mr-2" />
                          Sugar
                        </h5>
                        <p>
                          Fruit juice, sports drinks, sauces, salsas and salad
                          dressings.
                        </p>
                      </div>
                      <div className="col-lg-6 py-2">
                        ...
                        <p>
                          Wheat, corn, oats, barley, and other cereal grains.
                        </p>
                      </div>
                      <div className="col-lg-6 py-2">
                        <h5 className="text-uppercase mt-2">
                        ...
                        <p>
                          This includes aspartame, MSG, dyes, and artificial
                          flavourings.
                        </p>
                      </div>
                      <div className="col-lg-6 py-2">
