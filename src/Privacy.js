    ...
    return (
      <div className="">
        <PageTitle
          ...
          location={{ title: 'Privacy Policy', path: '/privacy-policy' }}
        />
        <div id="content">
          <div class="container">
            <div class="row">
              <div class="col-md-12">
                <div class="text-sm my-5">
                  <p>
                    ...
                    purchase from https://lifelixir.com.au (the “Site”).
                  </p>
                  ...
                  <p>
                    ...
                    please contact us by e-mail at support@lifelixir.com.au or
                    by mail using the details provided below:
                  </p>

                  <p>
                    15/12-14 Cecil st., Gordon, Sydney, ACT, 2072, Australia
                  </p>
                </div>
              </div>
            </div>
