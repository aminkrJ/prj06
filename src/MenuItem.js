...
class MenuItem extends Component {
  ...
  componentDidMount() {
    ...
    api
      .get('/recipes/' + this.props.match.params.slug)
      .then(response => {
        NProgress.done();
    ...
    return (
      <div id="content" class="pt-3 pt-lg-6 pb-lg-0">
        <Helmet>
          ...
          <meta
            name="description"
            content={this.state.recipe.short_description}
          />
        </Helmet>
        <div class="container">
          <div class="row">
                ...
                <div class="card-body p-4 pos-relative">
                  ...
                  <p
                    dangerouslySetInnerHTML={{
                      __html: this.state.recipe.short_description,
                    }}
                    class="lead"
                  />
                  <p
                  ...
                  <p
                    dangerouslySetInnerHTML={{
                      __html: this.state.recipe.how_to_cook,
                    }}
                    class="text-sm"
                  />
                </div>
